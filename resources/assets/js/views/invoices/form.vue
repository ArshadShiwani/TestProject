        ...
        <div class="panel-body">
            ...
            <table class="form-table">
                ...
                <tbody>
                    ...
                    <td class="w-14">
                        <input v-model="item.product" class="form-control" type="text">
                        <small v-if="errors[`items.${index}.product_id`]" class="error-control">
                            {{ errors[`items.${index}.product_id`][0] }}
                        </small>
                    </td>
                    <td class="w-4">
                        <input v-model="item.unit_price" class="form-control" type="text">
                        <small v-if="errors[`items.${index}.unit_price`]" class="error-control">
                            {{ errors[`items.${index}.unit_price`][0] }}
                        </small>
                    </td>
                    <td class="w-2">
                        <input v-model="item.qty" class="form-control" type="text">
                        <small v-if="errors[`items.${index}.qty`]" class="error-control">
